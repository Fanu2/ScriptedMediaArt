...
output_file = '/home/jasvir/Music/jodha9/jodha.mp4'
audio_file = '1.mp3'
...
# Ensure the video is at least 2 minutes long
total_duration = 120  # 2 minutes in seconds
while sum([clip.duration for clip in clips]) > total_duration:
    clips.extend(clips)

# Concatenate the clips
final_clip = concatenate_videoclips(clips, method="compose")
final_clip = final_clip.set_duration(total_duration)  # Set the duration of the final clip to 2 minutes
