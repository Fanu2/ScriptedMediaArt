...
def create_video(image_file, audio_file, subtitle_file, output_video, start_time='00:00:20'):
    try:
        ...
        # Step 1: Create a video from the image and audio with specified start time
        ...
        ffmpeg_image_audio_command = [
            ...
            "-loop", "1",
            "-i", image_file,
            "-ss", start_time,  # Start time for the audio
            "-i", audio_file,
            "-c:v", "libx264",
            "-tune", "stillimage",
            "-c:a", "aac",
...
if __name__ == "__main__":
    ...
    output_video = "/home/jasvir/Music/jodha8/jodha1.mp4"
    start_time = '00:00:20'  # Set start time for the audio (20 seconds into the file)

    # Create the video
    create_video(image_file, audio_file, subtitle_file, output_video, start_time)
